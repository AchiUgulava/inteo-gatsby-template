  ...
  return (
    <div id="#about">
      <div className="container mx-auto pt-20">
        ...
        <div className="grid lg:grid-cols-12 grid-cols-1 gap-8 lg:py-32 py-12 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col gap-6">
            ...
            <p className="md:text-body-lg text-body-md font-light text-neutral-700">
              With breathtaking city views, unique design elements, and
              unmatched amenities, this apartment stands as the ultimate peak of
              luxury in Tbilisi, Georgia. From the modern kitchen to the
              old-school twist in the library, every corner of this residence is
